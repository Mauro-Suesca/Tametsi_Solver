...
public class Level100 extends Level{
    @Override protected Board setup(){
        ...
        ColorCounter purple = new ColorCounter(13, "moradas", ESC + "35m");
        ColorCounter pink = new ColorCounter(8, "rosadas", ESC + "38;5;212m");
        ColorCounter blue = new ColorCounter(15, "azules", ESC + "34m");
        ColorCounter cyan = new ColorCounter(11, "cian", ESC + "36m");
