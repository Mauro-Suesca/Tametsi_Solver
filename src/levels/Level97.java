...
public class Level97 extends Level{
    @Override protected Board setup(){
        ColorCounter gray = new ColorCounter(53, "grises", ESC + "0m");
        ColorCounter pink = new ColorCounter(24, "rosadas", ESC + "38;5;212m");
        ColorCounter orange = new ColorCounter(23, "naranjas", ESC + "38;5;214m");
