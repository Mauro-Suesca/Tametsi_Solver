...
public class Level79 extends Level{
    @Override protected Board setup(){
        ColorCounter gray = new ColorCounter(14, "grises", "\u001B[0m");
        ColorCounter pink = new ColorCounter(19, "rosadas", "\u001B[38;5;212m");
        ColorCounter blue = new ColorCounter(10, "azules", "\u001B[34m");
        ColorCounter yellow = new ColorCounter(0, "amarillas", "\u001B[33m");
