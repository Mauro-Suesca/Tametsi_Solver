...
public class Level158 extends Level{
    @Override protected Board setup(){
        ...
        ColorCounter cyan = new ColorCounter(18, "cian", ESC + "36m");
        ColorCounter blue = new ColorCounter(21, "azules", ESC + "34m");
        ColorCounter pink = new ColorCounter(17, "rosadas", ESC + "38;5;212m");
        ColorCounter purple = new ColorCounter(21, "moradas", ESC + "35m");
