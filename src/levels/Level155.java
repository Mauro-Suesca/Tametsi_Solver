...
public class Level155 extends Level{
    @Override protected Board setup(){
        ColorCounter gray = new ColorCounter(38, "grises", ESC + "0m");
        ColorCounter red = new ColorCounter(17, "rojas", ESC + "31m");
        ColorCounter yellow = new ColorCounter(7, "amarillas", ESC + "33m");
