...
public class Level32 extends Level{
    @Override protected Board setup(){
        ColorCounter gray = new ColorCounter(3, "grises", ESC + "0m");
        ColorCounter purple = new ColorCounter(15, "moradas", ESC + "35m");
        ColorCounter cyan = new ColorCounter(4, "cian", ESC + "36m");
        ColorCounter orange = new ColorCounter(5, "naranjas", ESC + "38;5;214m");

        Board board = new BoardLineless(11, 13, true, gray, cyan, purple, orange);
        ...
        board.addCell(nonExistentCellFactory.build(1));
        board.addCell(new EmptyCell(orange, false, false));
        board.addCell(nonExistentCellFactory.build(1));
        board.addCell(new EmptyCell(orange, false, false));
        board.addCell(nonExistentCellFactory.build(1));
        board.addCell(cyanUnrevealedEmptyFactory.build(1));
