...
public class Level161 extends Level{
    @Override protected Board setup(){
        ColorCounter gray = new ColorCounter(58, "grises", ESC + "0m");
        ColorCounter cyan = new ColorCounter(27, "cian", ESC + "36m");
        ColorCounter pink = new ColorCounter(10, "rosadas", ESC + "38;5;212m");
