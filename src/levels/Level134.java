...
public class Level134 extends Level{
    @Override protected Board setup(){
        ColorCounter gray = new ColorCounter(33, "grises", ESC + "0m");
        ColorCounter blue = new ColorCounter(22, "azules", ESC + "34m");
        ColorCounter cyan = new ColorCounter(48, "cian", ESC + "36m");
