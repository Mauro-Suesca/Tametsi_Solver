...
public class Level116 extends Level{
    @Override protected Board setup(){
        ColorCounter gray = new ColorCounter(25, "grises", ESC + "0m");
        ColorCounter green = new ColorCounter(7, "verdes", ESC + "32m");
        ColorCounter orange = new ColorCounter(7, "naranjas", ESC + "38;5;214m");
        ColorCounter cyan = new ColorCounter(6, "cian", ESC + "36m");
        ColorCounter pink = new ColorCounter(8, "rosadas", ESC + "38;5;212m");
