...
public class Level133 extends Level{
    @Override protected Board setup(){
        ColorCounter gray = new ColorCounter(56, "grises", ESC + "0m");
        ColorCounter purple = new ColorCounter(17, "moradas", ESC + "35m");
        ColorCounter green = new ColorCounter(7, "verdes", ESC + "32m");
        ColorCounter cyan = new ColorCounter(13, "cian", ESC + "36m");
