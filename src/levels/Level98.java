...
public class Level98 extends Level{
    @Override protected Board setup(){
        ColorCounter gray = new ColorCounter(85, "grises", ESC + "0m");
        ColorCounter cyan = new ColorCounter(4, "cian", ESC + "36m");
        ColorCounter orange = new ColorCounter(4, "naranjas", ESC + "38;5;214m");
        ColorCounter pink = new ColorCounter(5, "rosadas", ESC + "38;5;212m");
        ColorCounter purple = new ColorCounter(5, "moradas", ESC + "35m");
