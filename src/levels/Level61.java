...
public class Level61 extends Level{
    @Override protected Board setup(){
        ...
        ColorCounter yellow = new ColorCounter(5, "yellow", ESC + "33m");
        ColorCounter orange = new ColorCounter(2, "orange", ESC + "38;5;214m");
        ColorCounter red = new ColorCounter(5, "red", ESC + "31m");
