...
public class Level88 extends Level{
    @Override protected Board setup(){
        ColorCounter gray = new ColorCounter(0, "grises", ESC + "0m");
        ColorCounter orange = new ColorCounter(24, "naranjas", ESC + "38;5;214m");
        ColorCounter green = new ColorCounter(13, "verdes", ESC + "32m");
        ColorCounter red = new ColorCounter(14, "rojas", ESC + "31m");
        ColorCounter yellow = new ColorCounter(16, "amarillas", ESC + "33m");
