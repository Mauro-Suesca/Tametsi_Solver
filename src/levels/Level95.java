...
public class Level95 extends Level{
    @Override protected Board setup(){
        ColorCounter gray = new ColorCounter(27, "grises", ESC + "0m");
        ColorCounter cyan = new ColorCounter(14, "cian", ESC + "36m");
        ColorCounter green = new ColorCounter(18, "verdes", ESC + "32m");
        ColorCounter yellow = new ColorCounter(15, "amarillas", ESC + "33m");
