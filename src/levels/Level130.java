...
public class Level130 extends Level{
    @Override protected Board setup(){
        ColorCounter gray = new ColorCounter(32, "grises", ESC + "0m");
        ColorCounter purple = new ColorCounter(29, "moradas", ESC + "35m");
        ColorCounter pink = new ColorCounter(8, "rosadas", ESC + "38;5;212m");
        ColorCounter orange = new ColorCounter(18, "naranjas", ESC + "38;5;214m");
