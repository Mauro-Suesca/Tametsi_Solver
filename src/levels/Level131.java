...
public class Level131 extends Level{
    @Override protected Board setup(){
        ColorCounter gray = new ColorCounter(37, "grises", ESC + "0m");
        ColorCounter red = new ColorCounter(20, "rojas", ESC + "31m");
        ColorCounter yellow = new ColorCounter(11, "amarillas", ESC + "33m");
