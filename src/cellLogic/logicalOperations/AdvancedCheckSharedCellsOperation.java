...
public class AdvancedCheckSharedCellsOperation extends LogicalOperation{
    public AdvancedCheckSharedCellsOperation(EmptyCell callingCell){
        super(callingCell, INTERMEDIATE_CHECK_SHARED_CELLS);
    }

    @Override public void executeOperation(){
        callingCell.advancedCheckSharedCells();
    }
