# Resolución de los niveles de Tametsi: Demostración Directa y por Contradicción
...
Posterior al trabajo para la asignatura de **Matemáticas Discretas I**, se añadió soporte para los niveles **6, 12, 13, 18, 20, 21, 23, 25, 27, 28, 30, 32, 34, 36, 37, 38, 42, 43, 44, 46, 47, 48, 50, 52, 53, 54, 55, 56, 57, 59, 60, 61, 63, 64, 65, 67, 69, 70, 71, 73, 75, 76, 78, 79, 80, 82, 84, 85, 87, 88, 89, 92, 93, 94, 95, 97, 98, 100, 114 (Lattice I), 115 (Lattice II), 116 (Lattice III), 117 (Tabs), 118 (Cyclone), 119 (Tatters), 120 (Combination Lock IV), 121 (Combination Lock V), 122 (Combination Lock VI), 129 (Circuit I), 130 (Circuit II), 131 (Circuit III), 132 (Stacks), 133 (Diverging Roads), 134 (Reticle), 151 (Stitches), 155 (Apologies to Mondrian), 157 (Capacity), 158 (Interlocked) y 161 (Weave)**, como trabajo independiente de Mauro Suesca.
